...
export const Confirmation = ({ onConfirm, onCancel }) => {
  ...
  return (
    <>
      ...
      >
        <div className="relative w-80 h-48 bg-memoir-light drop-shadow-lg rounded-xl flex flex-col justify-center items-center gap-2 p-4 text-center dark:bg-memoir-dark">
