...
export const NewNote = ({ addNote, closeModal }) => {
  ...
  return (
    ...
    >
      <div className="relative w-80 h-56 bg-memoir-light rounded-xl flex flex-col justify-center items-center gap-2">
        ...
        <div className="w-full flex justify-center items-center gap-2">
          <button className="memoir-btn-dark w-32" onClick={handleCreate}>
            Create
          </button>
